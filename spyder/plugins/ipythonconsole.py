...
from qtpy.QtWidgets import (QApplication, QCheckBox, QDialog, QDialogButtonBox,
                            ...
                            QTabWidget, QVBoxLayout, QWidget, QRadioButton, QSpacerItem, QComboBox)
...
class KernelConnectionDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.cb_remote_conn_files.currentIndexChanged.connect(self.__copy_remote_connection_file_and_choose_it)
    ...
    def __copy_remote_connection_file_and_choose_it(self, chosen_idx_of_combobox_with_remote_conn_files):
        ...
        try:
            ...
            if len(location_of_jupyter_runtime) > 0:
                ...
                if len(list_of_connection_files) > 0:
                    ...
                    # TODO: For later: show current status of the process. For some reason it's not working like this.
